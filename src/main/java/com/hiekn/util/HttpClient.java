...
public final class HttpClient {
	 ...
	 * @return 返回任意字符串
	 */
	public static String sendGet(String url,MultivaluedMap<String,Object> query, MultivaluedMap<String, Object> post){
		WebTarget webTarget = parseQueryParams(url,query);
		return webTarget.request().get(String.class);
	}
	
	/**
	 * 返回json字符串自动转成实体bean，即application/json
	 * @author DingHao
	 * @param url  请求路径
	 * @param query get参数
	 * @param post post参数
	 ...
	 * @return 实体bean
	 */
	public static <T> T sendGet(String url,MultivaluedMap<String,Object> query, MultivaluedMap<String, Object> post,Class<T> cls){
		WebTarget webTarget = parseQueryParams(url,query);
	 ...
	 * @param post post参数
	 * @param hsp 泛型类型
	 * @return 返回集合类型数据List<Object>
	 */
	public static <T> T sendGet(String url,MultivaluedMap<String,Object> query, MultivaluedMap<String, Object> post,GenericType<T> hsp){
		WebTarget webTarget = parseQueryParams(url,query);
	...
	public static String sendPost(String url, String post){
	    ...
	    String rs = webTarget.request(acceptContentType).post(Entity.text(post),String.class);
	    return rs;
	}
